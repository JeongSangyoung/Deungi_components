...
import MMainEventCard from '@/components/stories/molecules/MMainEventCard/MMainEventCard.vue';
...
<div class="main">
  <div class="main-wrap">
    ...
    <div class="main-cards">
      <MMainEventCard>
        <template #header>
          <p class="mEvent-txt_3">혜택 <b>1</b></p>
        </template>
        <template #content>
      ...
      <MMainEventCard>
        <template #header>
          <p class="mEvent-txt_3">혜택 <b>2</b></p>
        </template>
        <template #content>
          <div class="mEvent-wrap">
            <div>
      ...
      <MMainEventCard>
        <template #header>
          <p class="mEvent-txt_3">혜택 <b>3</b></p>
        </template>
        <template #content>
          <div class="mEvent-wrap">
            <div>
...
.main {
  background: url('https://deungi24.com/img/main_slider_3.gif') no-repeat center 0px;
